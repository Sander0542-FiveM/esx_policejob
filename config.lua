...
Config.PoliceStations = {
	...
	VEPD = {
		...
		Helicopters = {
			{
				Spawner    = vector3(-1084.46, -837.46, 37.67),
				SpawnPoint = vector3(-1096.4, -832.79, 37.68),
				Heading    = 0.0
			}
		},
	...
	VBPD = {
		...
		Blip = {
			Coords     = vector3(-1179.17, -1776.72, 3.91),
			Sprite  = 60,
			Display = 4,
			Scale   = 1.2,
			Colour  = 29,
		...
		Cloakrooms = {
			vector3(-1182.19, 1772.19, 3.91),
		},
	
		Armories = {
			vector3(-1177.47, -1780.42, 3.91),
		},
	
		Vehicles = {
			{
				Spawner    = vector3(-1171.15, -1757.34, 3.96),
				SpawnPoints = {
					{coords = vector3(-1177.13, -1744.19, 4.03), heading = 213.6, radius = 6.0},
					{coords = vector3(-1170.87, -1739.61, 4.06), heading = 220.5, radius = 6.0}
				}
			},
	
			{
				Spawner    = vector3(-1157.68, -1749.1, 4.03),
				SpawnPoints = {
					{coords = vector3(-1159.17, -1730.55, 4.16), heading = 210.2, radius = 6.0},
					{coords = vector3(-1165.44, -1735.6, 4.1), heading = 210.7, radius = 6.0}
				}
			}
		},
		...
		Helicopters = {
			{
				Spawner    = vector3(-1182.19, 1772.19, 3.91),
				SpawnPoint = vector3(-1179.99, 1719.11, 4.31),
				Heading    = 0.0
			}
		},
	
		VehicleDeleters = {
			vector3(-1167.96, -1771.35, 3.89),
			vector3(-1169.96, -1767.9, 3.87)
		},
	
		BossActions = {
			vector3(-1179.17, -1776.72, 3.91)
		}
	...
	SSPD = {
		...
		Helicopters = {
			{
				Spawner    = vector3(1730.73, 3607.64, 34.94),
				SpawnPoint = vector3(1725.55, 3617.25, 36.95),
				Heading    = 0.0
			}
		},
	...
	PLPD = {
		...
		Helicopters = {
			{
				Spawner    = vector3(-462.27, 5998.8, 31.3),
				SpawnPoint = vector3(-482.62, 5996.44, 33.22),
				Heading    = 0.0
			}
		},
